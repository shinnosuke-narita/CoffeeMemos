...
import com.withapp.coffeememo.viewModel.EditBeanViewModel
import com.withapp.coffeememo.viewModel.EditBeanViewModelFactory
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.beanStarList.observe(viewLifecycleOwner) { starList ->
            for ((index, star) in starList.withIndex()) {
                if (star.state == RatingManager.StarState.LIGHT) beanStarViewList[index].setImageResource(
