package com.example.coffeememos.search.bean.presentation.fragment
...
import com.example.coffeememos.search.bean.presentation.view_model.BeanFilterViewModel
...
class BeanFilterFragment : BaseFilterFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // viewModel 初期化
        viewModel.initialize(parentViewModel.controller)
    }
